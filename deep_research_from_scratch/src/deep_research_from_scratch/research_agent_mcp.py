...
# Initialize models
compress_model = init_chat_model(model="gemini-2.0-flash-exp", model_provider="google-genai", max_tokens=32000)
model = init_chat_model(model="gemini-2.0-flash-exp", model_provider="google-genai", max_tokens=32000)
