...
writer_model = init_chat_model(model="gemini-2.0-flash-exp", model_provider="google-genai", max_tokens=32000, temperature=0.0) # model="anthropic:claude-sonnet-4-20250514", max_tokens=64000
